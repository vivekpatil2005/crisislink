...
export class Backend implements backendInterface {
    ...
    async filterSafeZonesByState(arg0: string): Promise<Array<SafeZone>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterSafeZonesByState(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async filterSafeZonesByType(arg0: string): Promise<Array<SafeZone>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterSafeZonesByType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLatestAlerts(): Promise<Array<SOSAlert>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestAlerts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitSos(arg0: string, arg1: string, arg2: number, arg3: number): Promise<SOSAlert> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSos(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
